package com.example.tea_time.IdlingResource;
...
public class ImageDownloader {
     ...
     */
    public static void downloadImage(Context context, final DelayerCallback callback,
